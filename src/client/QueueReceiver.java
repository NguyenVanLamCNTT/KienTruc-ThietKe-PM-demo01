...
public static void main(String[] args) throws Exception{
    ...
    Destination destination2 = (Destination) ctx.lookup("dynamicQueues/logan");
    //tạo connection
    ...
    MessageConsumer receiver2 = session.createConsumer(destination2);
    ...
    public void onMessage(Message msg) {//msg là message nhận được
        ...
        System.out.println("Logan was listened on queue...");
        ...
        public void onMessage(Message msg) {//msg là message nhận được
            ...
            if(msg instanceof TextMessage){
                TextMessage tm=(TextMessage)msg;
                String txt=tm.getText();
                System.out.println("Nhận được logan: "+txt);
                msg.acknowledge();//gửi tín hiệu ack
            }
            else if(msg instanceof ObjectMessage){
                ObjectMessage om=(ObjectMessage)msg;
